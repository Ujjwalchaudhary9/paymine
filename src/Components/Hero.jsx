...
const Hero = () => {
  return (
    <div className="relative w-full h-[84vh]">
      ...
      {/* Overlay Content */}
      <div className=" text-blue-900 capitalize absolute inset-0 bg-[#83b1e361] bg-opacity-50 flex flex-col items-start md:pl-36 pl-10 justify-center text-left">
        <h1 className="lg:text-6xl text-4xl font-bold capitalize w-[50vw]">
         We provide the Smart, Secure, and Swift Payments.
        </h1>
        <p className="text-2xl mt-6 font-semibold">Lightning-fast payment processing saves you time and enhances productivity.</p>
      </div>
